...
public class BoWFeatures extends FeatureGenerator {
	...
	public List<List<Object>> generateFeaturesFromTrainData() {
		...
		text = getBoilerPlateText(true, true); 
		System.out.println("List Size:"+text.size());

		preprocessData(true);
		
		nsize = text.size();
		List<String> keys = new ArrayList<String>(terms.keySet());
		Comparator comp = new DFSort();
	...
	public List<List<Object>> generateFeaturesFromTestData() {
		...
		text = getBoilerPlateText(false, true); 
		System.out.println("List Size:"+text.size());
	...
	public static void main(String[] args) {
		...
		List<Map<String, Object>> list_feats =  FeatureGenerator.getCompetitionFeaturesMap(false,true);
